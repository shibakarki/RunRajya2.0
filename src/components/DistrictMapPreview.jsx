...
// Centered coordinate shifted slightly northward to bring the whole shape down
...
export default function DistrictMapPreview() {
  ...
  return (
    <div className="w-full h-64 md:h-80 bg-zinc-950 border border-zinc-900 rounded-2xl flex flex-col relative overflow-hidden select-none shadow-2xl">
      ...
      <div className="absolute top-4 left-4 flex flex-col gap-0.5 z-[40] pointer-events-none drop-shadow-md">
      ...
      <div className="absolute top-4 right-4 z-[40] pointer-events-none drop-shadow-md">
      ...
      */}
      ...
      <div className="border-t border-zinc-900 px-4 py-2 bg-zinc-950/80 flex items-center justify-between text-[9px] font-mono text-zinc-500 z-[40]">
